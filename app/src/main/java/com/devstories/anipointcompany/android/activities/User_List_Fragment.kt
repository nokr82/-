...
class User_List_Fragment : Fragment() {
    ...
    lateinit var main_new_userLL : LinearLayout
    lateinit var main_most_freq_userLL : LinearLayout
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        main_new_userLL = view.findViewById(R.id.main_new_userLL)
        main_most_freq_userLL = view.findViewById(R.id.main_most_freq_userLL)
    ...
    fun birthData() {
        ...
        MemberAction.today_birth_user(params, object : JsonHttpResponseHandler() {
